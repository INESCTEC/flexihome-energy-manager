...
def baseline_post(day: datetime, asset: str, power_values: list):
    ...
    generalLogger.info(f'Begin Cybergrid baseline \"POST\" SSA for asset {asset} on {day}')
    ...
    react_response, react_status_code = cybergrid_ssa.ask_or_post(
        bindings=bindings,
        ki_id=cybergrid_ssa.baseline_ki_id,
    ...
    generalLogger.debug('Cybergrid baseline \"POST\" SSA... Finished')
