...
class PTPilotReactiveCybergridSSA(SSA):
    ...
    def setup(self, ss_email: str, ss_password: str, kb_name: str, kb_description: str, asset_id: str):
        ...
        self.pt_pilot_reactive_kb_id = self.register_ssa_smart_connect_flow(
            ss_email=ss_email,
        ...
        arg_gp_path = os.path.join(dirname, "setpoint.gp")

        self.setpoint_ki_id = self.register_post_react_ki(
            kb_id=self.pt_pilot_reactive_kb_id,
            ki_type=KiTypeShort.REACT.value,
            ki_name=CybergridConfig.SETPOINT_KI_NAME,
